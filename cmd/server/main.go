...
import (
	...
	pgInfra "github.com/e-go/backend/internal/infrastructure/postgres"
	redisInfra "github.com/e-go/backend/internal/infrastructure/redis"
	"github.com/e-go/backend/internal/middleware"
	"github.com/e-go/backend/internal/router"
	"github.com/e-go/backend/internal/services"
	"github.com/e-go/backend/internal/services/lifecycle"
	"github.com/e-go/backend/pkg/httpcontext"
	"github.com/e-go/backend/pkg/logger"
	"github.com/e-go/backend/repository/postgres"
	redisRepo "github.com/e-go/backend/repository/redis"
